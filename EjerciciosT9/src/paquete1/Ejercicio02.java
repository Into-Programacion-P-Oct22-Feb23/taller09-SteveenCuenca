...
public class Ejercicio02 {
    ...
    public static void main(String[] args) {
        ...
        String[] rangos = {"1-5", "6-10", "11-15", "16-20", "21-n o -n-0"};
...
//Se añade un "else" y al final u "printf" para predentar los valores
//que estan fuera de rago y de agrega un valor al rango.
            }
        }
        ...
        System.out.printf("Valor fuera de rango:%s - valor %d\n",
                rangos[4], valoresRangos[4]);
    }
